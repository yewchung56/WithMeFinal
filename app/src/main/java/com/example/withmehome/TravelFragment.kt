...
class TravelFragment:Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return binding.root
        val WriteRecruitmentActivity = inflater.inflate(R.layout.fragment_travel,container, false)
        val btn_event= WriteRecruitmentActivity.findViewById<Button>(R.id.travel)
